...
class KidsBlog extends Component {
    constructor(props) {
        super(props);
        this.state = {  };
    }
            ...
            <Col lg={4} className="col-12">
              ...
              <div className="card border-0 bg-transparent">
                <div className="position-relative rounded overflow-hidden">
                  ...
                  <img className="card-img-top hover-zoom" src={require(`../../assets/images/kids/blog/01.jpg`)} alt="Image" />
                </div>
            ...
            <Col lg={4} className="col-12 mt-5 mt-lg-0">
              ...
              <div className="card border-0 bg-transparent">
                <div className="position-relative rounded overflow-hidden">
                  ...
                  <img className="card-img-top hover-zoom" src={require(`../../assets/images/kids/blog/02.jpg`)} alt="Image" />
                </div>
                <div className="card-body px-0 pb-0">
                  <div> <Link className="d-inline-block link-title btn-link text-small mr-2" to="#">Cloth,</Link>
                    <Link className="d-inline-block link-title btn-link text-small" to="#">Fashion</Link>
            ...
            <Col lg={4} className="col-12 mt-5 mt-lg-0">
              ...
              <div className="card border-0 bg-transparent">
                <div className="position-relative rounded overflow-hidden">
                  ...
                  <img className="card-img-top hover-zoom" src={require(`../../assets/images/kids/blog/03.jpg`)} alt="Image" />
                </div>
                <div className="card-body px-0 pb-0">
                  <div> <Link className="d-inline-block link-title btn-link text-small mr-2" to="#">Cloth,</Link>
                    <Link className="d-inline-block link-title btn-link text-small" to="#">Fashion</Link>
