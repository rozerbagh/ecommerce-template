                            ...
                            <div className="col-lg-8 col-md-7">
                                <div className="card-info">
                                    <div className="card-body">
                                        ...
                                        <p className="mb-3 mt-2">{productdata.description}</p>
                                    </div>
                                    <div className="card-footer bg-transparent border-0">
                                        <div className="product-link d-flex align-items-center">
                                            {!this.WishlistItems(productdata.id) ?
                                                <Link to="#" onClick={() => this.Productaddwishlist(productdata.id, productdata.name, productdata.pictures[0], 1, productdata.salePrice, "In Stock")} className="btn btn-compare" id="addtowish"><i class="lar la-heart mr-1" ></i></Link>
                                                :
                                                <Link to="/cart" className="btn btn-compare" id="viewwishlist"><i class="las la-heart mr-1" ></i></Link>
                                            }
                                            {!this.CartItems(productdata.id) ?
                                                <Link to="#" onClick={() => this.Productaddcart(productdata.id, productdata.name, productdata.pictures[0], 1, productdata.salePrice, "In Stock")} className="btn-cart btn btn-primary btn-animated mx-3" rel="nofollow" id="addtocard"><i className="las la-shopping-cart mr-1" /></Link>
                                                :
                                            ...
                                            <Link to="#" onClick={() => this.onClickQuickView(productdata)} className="btn btn-view" id="quickview"><i className="las la-eye" /></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
